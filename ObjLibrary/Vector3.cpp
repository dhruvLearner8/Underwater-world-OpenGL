...
ostream& ObjLibrary :: operator<< (ostream& r_os,
...
std::istream& ObjLibrary :: operator>> (std::istream& r_is,
                                        Vector3& r_vector)
{
	// eat whitespace
	r_is >> std::ws;

	int next = r_is.peek();  // peek character
