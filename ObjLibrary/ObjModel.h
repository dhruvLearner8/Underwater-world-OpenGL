...
//  save
//
//  Purpose: To write the contents of this ObjModel to a file
//           with the current file name and path.  In most
//           cases, this is the file this ObjModel was loaded
//           from.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: N/A
...
//               ObjModel is then written to that file in OBJ
...
//               overwritten.  This ObjModel isthen  written to
//               that file in OBJ format.  If a logfile or
//               logging stream is specified, any errors are
...
//           too slow.
//  Parameter(s):
//    <1> is_print_invalid: Whether to print why this model is
//                          invalid
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: The validity of this model is recalculated.
//               This will never result in a model marked as
//               valid being marked as invalid.  If
//               is_print_invalid == true, a message will be
//               printed for each invalid point set, polyline,
//               and face explaining why it is invalid.
//
	void validate (bool is_print_invalid);
