...
//  isGlutInitialized
//
//  Purpose: To determine if glutInit has been called.  Before
//           this, TextureBmps cannot be converted to OpenGL
//           textures.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: Whether the GLUT context has been initialized.  If
//           this cannot be determined, true is returned.
//  Side Effect: N/A
//
	static bool isGlutInitialized ();
...
//    <5> textures_width != 0
//    <6> textures_height != 0
//    <7> The specified textures do not exceed the bounds of the
//        texture in the file
//    <8> a_names is large enough to hold all the texture names
//        generated
//  Returns: N/A
...
//    <5> textures_width != 0
//    <6> textures_height != 0
//    <7> The specified textures do not exceed the bounds of
...
//  isSquare
//
//  Purpose: To determine if this TextureBmp is has the same
//           width and height.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: Whether the width and height of this TextureBmp are
//         equal.
//  Side Effect: N/A
//
	bool isSquare () const
...
//  Precondition(s):
//    <1> a_filename != NULL
//    <2> ObjStringParsing::isValidFilenameWithPath(filename)
//    <2> ObjStringParsing::isValidFilenameWithPath(a_filename)
//  Returns: N/A
//  Side Effect: This TextureBmp is saved as a .bmp file named
//               a_filename/filename.  The alpha channel for
//               this TextureBmp, if any, is ignored.
//
...
//  rotateCCW
//
//  Purpose: To rotate this TextureBmp 90 degrees
//           clockwise/counter-clockwise.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: This TextureBmp is rotated by a quarter-turn in
//               the indicateed direction.  If it is not a
//               square texture, its dimensions are swapped.
//
	void rotateCW ();
	void rotateCCW ();
...
//  rotate180
//
//  Purpose: To rotate this TextureBmp 180 degrees.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: This TextureBmp is rotated by a half-turn.
//               This is equivilent to mirroring it in both
//               directions.
//
	void rotate180 ();
...
//               rgb.  Note that rgb is assumed to include an
//               alpha component if this TextureBmp has an alpha
//               channel.
//               channel and not otherwise.
//
	void setPixel (unsigned int x,
	               unsigned int y,
	               unsigned int rgb);
...
//  fill
//
//  Purpose: To change the colour of all pixels in this
//           TextureBmp to the specified values.
//  Parameter(s):
//    <1> red
//    <2> green
//    <3> blue: The colour for this texture
//    <4> alpha: The alpha value for this texture
//  Precondition(s):
//    <1> !isAlphaChannel()
//  Returns: N/A
//  Side Effect: Every pixel is set to have colour
//               (red, green, blue).
//
...
//  fill
//
//  Purpose: To change the colour and transparency of all pixels
//           in this TextureBmp to the specified values.
//  Parameter(s):
//    <1> red
//    <2> green
//    <3> blue: The colour for this texture
...
//  Returns: N/A
//  Side Effect: Every pixel is set to have colour
//               (red, green, blue) and alpha value alpha.
//
	void fill (unsigned char red,
	           unsigned char green,
	           unsigned char blue,
...
//           stored in the least significant bits.
//  Parameter(s):
//    <1> rgb: The colour for this pixel in RGB(A) format
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: Every pixel is set to have colour rgb.  Note
//               that rgb is assumed to include an alpha
//               component if this TextureBmp has an alpha
//               channel and not otherwise.
//
...
//    <2> wrap_s == GL_REPEAT || wrap_s == GL_CLAMP
//    <3> wrap_t == GL_REPEAT || wrap_t == GL_CLAMP
#else
//    <2> wrap   == GL_REPEAT ||
