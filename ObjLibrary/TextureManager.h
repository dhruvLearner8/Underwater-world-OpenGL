...
//               has wrapping mode GL_REPEAT in the S and T
//               directions and magnification and minification
//               filters controlled by the value of
...
//    <4> wrap_s == GL_REPEAT || wrap_s == GL_CLAMP
//    <5> wrap_t == GL_REPEAT || wrap_t == GL_CLAMP
#else
//    <4> wrap_s == GL_REPEAT ||
...
#endif
//    <6> mag_filter == GL_NEAREST ||
//        mag_filter == GL_LINEAR
//    <7> min_filter == GL_NEAREST ||
//        min_filter == GL_LINEAR ||
//        min_filter == GL_NEAREST_MIPMAP_NEAREST ||
//        min_filter == GL_NEAREST_MIPMAP_LINEAR ||
//        min_filter == GL_LINEAR_MIPMAP_NEAREST ||
//        min_filter == GL_LINEAR_MIPMAP_LINEAR
//    <8> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: The index of the texture loaded.  If the texture
//           could not be loaded, TEXTURE_LOADING_ERROR is
//           returned.
//  Side Effect: If a suitable file with name a_name/name
...
//  load
//
//  Purpose: To load a texture with the specified name and
//           transparent colour.
//  Parameter(s):
//    <1> a_name: The name of the texture
//    <1> name: The name of the texture
//    <3> transparent_colour: The transparency colour
//    <4> logfile: The file to write loading errors to
//    <4> r_logstream: The stream to write loading errors to
//  Precondition(s):
//    <1> Texture::isGlutInitialized()
//    <2> a_name != NULL
//    <3> !isLoaded(a_name)
//    <3> !isLoaded(name)
//    <4> transparent_colour.isAllComponentsNonNegative()
//    <5> transparent_colour.isAllComponentsLessThanOrEqual(1.0)
//    <6> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: The index of the texture loaded.  If the texture
//           could not be loaded, TEXTURE_LOADING_ERROR is
//           returned.
//  Side Effect: If a suitable file with name a_name/name
...
//               directions and magnification and minification
//               filters controlled by the value of
//               OBJ_LIBRARY_LINEAR_TEXTURE_INTERPOLATION.  All
//               pixels of colour transparent_colour are set to
//               have an alpha value of 0.0, and all other
...
//    <7> r_logstream: The stream to write loading errors to
//  Precondition(s):
//    <1> Texture::isGlutInitialized()
//    <2> a_name != NULL
//    <3> !isLoaded(a_name)
...
//        min_filter == GL_LINEAR_MIPMAP_NEAREST ||
//        min_filter == GL_LINEAR_MIPMAP_LINEAR
//    <8> transparent_colour.isAllComponentsNonNegative()
//    <9> transparent_colour.isAllComponentsLessThanOrEqual(1.0)
//   <10> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: The index of the texture loaded.  If the texture
//           could not be loaded, TEXTURE_LOADING_ERROR is
//           returned.
//  Side Effect: If a suitable file with name a_name/name
