...
//           this, only empty DisplayLists can be created.
//  Parameter(s): N/A
//  Precondition(s): N/A
...
//  isDisabledForExit
//
//  Purpose: To determine if all DisplayLists are in the special
//           program end state.  In this state, nothing
//           interesting can be done with them.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: Whether all DisplayLists are in program end state.
//  Side Effect: N/A
//
	static bool isDisabledForExit ();

//
//  disableAllForExit
//
//  Purpose: To prepare all DisplayLists for program end.  This
//           prevents them from being explicitly deleted.  This
//           command cannot be undone.
//  Parameter(s): N/A
//  Precondition(s): N/A
//    <1> !isDisabledForExit()
//  Returns: N/A
//  Side Effect: A global flag is set to prevent any
//               DisplayLists from being deleted.  This prevents
//               errors caused by deleting display lists after
//               the OpenGL context has been destroyed.
//
//  Warning: This doesn't work very well.  I don't know when you
//           call it.  Maybe glutCloseFunc?  <|>
//
	static void disableAllForExit ();
