...
//           this, only uninitialized SpriteFonts can be
//           created.
//  Parameter(s): N/A
//  Precondition(s): N/A
...
//    <1> isGlutInitialized()
//    <2> a_image != NULL
//    <3> ObjStringParsing::isValidFilenameWithPath(a_image)
//    <4> File a_image exists
//    <5> File a_image is a valid 24-bit bitmap file
//    <6> The width of a_image is at least 16
//    <7> The width of a_image is a power of 2
//    <8> The height of a_image is equal to exactly or half the
//        width of a_image
//    <9> red != green || red != blue
//  Returns: N/A
...
//  Precondition(s):
//    <1> isGlutInitialized()
//    <2> ObjStringParsing::isValidFilenameWithPath(image)
//    <3> File a_image exists
//    <4> File a_image is a valid 24-bit bitmap file
//    <5> The width of a_image is at least 16
//    <6> The width of a_image is a power of 2
//    <7> The height of a_image is equal to exactly or half the
//        width of a_image
...
//    <2> a_image != NULL
//    <3> ObjStringParsing::isValidFilenameWithPath(a_image)
//    <3> ObjStringParsing::isValidFilenameWithPath(image)
//    <4> File a_image exists
//    <5> File a_image is a valid 24-bit of 32-bit bitmap file
//    <6> The width of image/a_image is at least 16
//    <7> The width of image/a_image is a power of 2
//    <8> The height of image/a_image is equal to exactly or
...
//    <2> !isInitialized()
//    <3> a_image != NULL
//    <4> ObjStringParsing::isValidFilenameWithPath(a_image)
//    <4> ObjStringParsing::isValidFilenameWithPath(image)
//    <5> File a_image exists
//    <6> File a_image is a valid 24-bit of 32-bit bitmap file
//    <7> The width of image/a_image is at least 16
//    <8> The width of image/a_image is a power of 2
//    <9> The height of image/a_image is equal to exactly or
//        half of the width of image/a_image
//   <10> red != green || red != blue
//  Returns: N/A
//  Side Effect: This SpriteFont is initialized with image
